...
class EmployeeRepositoryIntegrationTests {
    ...
    void setUp() {
        ...
        databaseClient.sql("INSERT INTO employee (uuid, first_name, last_name, employee_type) VALUES (:uuid, :firstName, :lastName, :employeeType)")
    ...
    void givenNoEmployee_whenGetEmployeeById_thenReturnsEmpty() {
        StepVerifier.create(employeeRepository.getEmployeeById(UUID.randomUUID()))
                .verifyComplete();
    }
}
